...
ALLOWED_HOSTS = ['sudo-ai.com', 'www.sudo-ai.com', 'localhost', '127.0.0.1', 'quiz-rag.sudo-ai.com', '0.0.0.0']
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.environ.get('DB_PASSWORD', 'Secret1975'),  # Will use env var if available
